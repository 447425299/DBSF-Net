...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        # basic parameters
        parser.add_argument('--dataroot', default='/media/omnisky/c99d018c-43b1-422f-adc0-b0f5339eb213/wll/datasets/KAIST', help='path to images (should have subfolders trainA, trainB, valA, valB, etc)')
        parser.add_argument('--name', type=str, default='KAIST', help='name of the experiment. It decides where to store samples and models')
        ...
        parser.add_argument('--netD', type=str, default='basic', choices=['basic','combine', 'n_layers', 'pixel', 'patch', 'tilestylegan2', 'stylegan2'], help='specify discriminator architecture. The basic model is a 70x70 PatchGAN. n_layers allows you to specify the layers in the discriminator')
